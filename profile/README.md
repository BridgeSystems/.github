...
C# source and verified against golden fixtures. Every repository ships a **getting-started
console sample** that runs the whole workflow against a live Data Connector and prints each
request and response — the fastest way to learn the protocol.
